...
const commonAttributes = {
  ...
  'source': ['src', 'type'],
  'button': ['type', 'class', 'id', 'popover', 'popovertarget', 'popovertargetaction', 'aria-label'],
  'input': ['type', 'class', 'id', 'checked', 'min', 'max', 'step', 'value', 'aria-label'],
  'label': ['for', 'class', 'aria-label'],
  'div': ['class', 'id', 'style', 'data-src', 'data-title', 'data-artist', 'data-duration', 'data-waveform', 'data-voice', 'data-filesize', 'data-mounted'],
